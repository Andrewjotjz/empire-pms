        ...
        <div className="bg-white shadow-lg rounded-lg overflow-hidden">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 p-6">
            <div className="space-y-4">
              ...
              <p className="flex items-center"><span className="font-medium mr-2 text-gray-600">ID:</span> {deliveryState._id}</p>
            ...
            <div className="space-y-4">
              ...
              <p className="flex items-center"><span className="font-medium mr-2 text-gray-600">Order:</span> {deliveryState.order}</p>
              <p className="flex items-center">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6 mr-2">
                      <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 6a3.75 3.75 0 1 1-7.5 0 3.75 3.75 0 0 1 7.5 0ZM4.501 20.118a7.5 7.5 0 0 1 14.998 0A17.933 17.933 0 0 1 12 21.75c-2.676 0-5.216-.584-7.499-1.632Z" />
                  </svg>
                  <span className="font-medium mr-2 text-gray-600">Supplier:</span> {deliveryState.supplier}</p>
              <p className="flex items-center">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6 mr-2">
          ...
          <div className="p-6 border-t border-gray-200">
            ...
            <p className="bg-gray-50 p-3 rounded-md">{deliveryState.delivery_notes}</p>
          </div>
            ...
            <div className="overflow-x-auto">
              <table className="min-w-full bg-white">
                <thead className="bg-gray-100">
                  <tr>
                    <th className="py-3 px-4 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Product Ref</th>
                ...
                <tbody className="divide-y divide-gray-200">
                  {deliveryState.products.map((product) => (
                    <tr key={product._id} className="hover:bg-gray-50 transition-colors duration-200">
                      <td className="py-4 px-4 text-sm text-gray-900">{product.product_obj_ref}</td>
