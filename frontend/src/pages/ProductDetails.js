            ...
            <table className="w-full">
              <thead>
                <tr className="bg-indigo-200 border-b border-indigo-300">
                  <th className="px-4 py-3 text-left text-sm font-semibold text-gray-800 hidden sm:table-cell">
                    <div className="flex items-center gap-2">
                      <Calendar className="w-4 h-4" />
                      Effective Date
                    </div>
                  </th>
                  <th className="px-4 py-3 text-center text-sm font-semibold text-gray-800">Unit A</th>
                  <th className="px-4 py-3 text-center text-sm font-semibold text-gray-800">Unit B</th>
                  <th className="px-4 py-3 text-center text-sm font-semibold text-gray-800 hidden sm:table-cell">
                    Price Fixed
                  </th>
                  <th className="px-4 py-3 text-center text-sm font-semibold text-gray-800 hidden sm:table-cell">
                    Actual Rate
              ...
              <tbody>
                {productState.map((item, index) => (
                  ...
                  >
                    ...
                    <td className="px-4 py-4 text-center text-sm text-indigo-700 hidden sm:table-cell">
                      <span className="font-semibold bg-indigo-100 px-2 py-1 rounded">
                        ${item.productPrice.product_actual_rate}
                      </span>
                    </td>
                    <td className="px-4 py-4 text-center text-sm text-gray-600 hidden sm:table-cell max-w-xs">
                    ...
                    <td className="px-4 py-4 text-center relative">
                      ...
                      {selectedPriceId === item.productPrice._id && localUser.employee_roles === "Admin" && (
                        <div className="absolute top-full right-4 mt-2 z-10">
                          <button className="flex items-center gap-2 border border-gray-300 shadow-lg px-4 py-2 text-sm rounded-lg hover:bg-gray-50 hover:border-gray-400 hover:scale-105 transition-all duration-150 whitespace-nowrap">
            ...
            {localUser.employee_roles === "Admin" && (
              <div className="relative">
                <button
                  ...
                  className="flex items-center gap-2 bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded-lg font-medium transition-colors duration-150"
                >
                  ACTIONS
                  <ChevronDown
...
//                     {productState.map((item, index) => (
//                         <tr key={index} onClick={() => handlePriceTableClick(item.productPrice._id)} className='hover:cursor-pointer relative hover:bg-gray-100'>
...
//                                     </label>
//                                 ))}
//                                 {selectedPriceId === item.productPrice._id && (
//                                     <button className="absolute top-full right-0 mt-1 z-10 border border-gray-300 bg-white shadow-md px-4 py-2 text-sm rounded-md whitespace-nowrap hover:font-bold hover:text-black cursor-pointer transition-colors duration-150">
//                                         EDIT PRICE
//                                     </button>
//                                 )}
//                                 </div>
