...
const NewBudgetForm = () => {
  ...
  // ];
  // const productTypes = [
  //   { _id: 'pt1', type_name: 'Plasterboard' },
  //   { _id: 'pt2', type_name: 'Framing Wall' },
  //   { _id: 'pt3', type_name: 'Framing Ceiling' },
  //   { _id: 'pt4', type_name: 'Batt Insulation' },
  //   { _id: 'pt5', type_name: 'Rigid Insulation' },
  //   { _id: 'pt6', type_name: 'External Cladding' },
  //   { _id: 'pt7', type_name: 'Access Panel' },
  //   { _id: 'pt8', type_name: 'Compound' },
  // ];
  ...
  //   pt1: [
  //     { _id: 'c1', category_name: '13mm RE' },
  //     { _id: 'c2', category_name: '13mm WR' },
  //     { _id: 'c3', category_name: '16mm FR' },
  //     { _id: 'c4', category_name: '13mm FR' },
  //     { _id: 'c5', category_name: '16mm WRFR' },
  //     { _id: 'c6', category_name: '13mm WRFR' },
  //     { _id: 'c7', category_name: 'Wastage' },
  //   ],
  //   pt2: [
  //     { _id: 'c8', category_name: '64mm Stud (3m Height) (0.5BMT)' },
  //     { _id: 'c9', category_name: '92mm Stud (3m Height) (0.7BMT)' },
  //     { _id: 'c10', category_name: '92mm Quiet Stud (3m Height) (0.7BMT)' },
  //     { _id: 'c11', category_name: '28mm / 37mm Furring Channel' },
  //   ]
  // };
  ...
  // const subcategories = {
  //   c8: [
  //     { _id: 'sc1', subcategory_name: '64mm top track' }, 
  //     { _id: 'sc2', subcategory_name: '64mm bottom track' },
  //     { _id: 'sc3', subcategory_name: '64mm stud' },
  //     { _id: 'sc4', subcategory_name: '64mm nogging track' }
  //   ],
  //   c9: [
  //     { _id: 'sc5', subcategory_name: '92mm top track' }, 
  //     { _id: 'sc6', subcategory_name: '92mm bottom track' },
  //     { _id: 'sc7', subcategory_name: '92mm stud' },
  //     { _id: 'sc8', subcategory_name: '92mm nogging track' }
  //   ],
  //   c10: [
  //     { _id: 'sc9', subcategory_name: '92mm top track' }, 
  //     { _id: 'sc10', subcategory_name: '92mm bottom track' },
  //     { _id: 'sc11', subcategory_name: '92mm stud' },
  //     { _id: 'sc12', subcategory_name: '92mm nogging track' }
  //   ],
  //   c11: [
  //     { _id: 'sc13', subcategory_name: '28mm / 37mm Furring Channel' }
  //   ],
  // };
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => {
                      ...
                      // Reset category_id and subcategory_id when product type changes
                      handleEntryChange(index, 'category_obj_ref', 'category_id', '');
                      handleEntryChange(index, 'subcategory_obj_ref', 'subcategory_id', '');
                    }}
                    className="w-full px-2 py-1 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition duration-150 ease-in-out"
                  >
                    <option value="">Select Product Type</option>
                    {productTypeState.map((pt) => (
                      <option key={pt._id} value={pt._id}>{pt.type_name}</option>
                    ))}
                  </select>
                </div>
                <div>
            ...
            <div className="mb-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <select
                    value={entry.category_obj_ref.category_id}
                    onChange={(e) => {
                      handleEntryChange(index, 'category_obj_ref', 'category_id', e.target.value);
                      // Reset subcategory_id when category_id changes
                      handleEntryChange(index, 'subcategory_obj_ref', 'subcategory_id', '');
                    }}
                    className="w-full px-2 py-1 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition duration-150 ease-in-out disabled:bg-gray-200"
            ...
            <div className="mb-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <select
                    value={entry.subcategory_obj_ref.subcategory_id}
                    onChange={(e) => handleEntryChange(index, 'subcategory_obj_ref', 'subcategory_id', e.target.value )}
                    className="w-full px-2 py-1 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition duration-150 ease-in-out disabled:bg-gray-200"
                    disabled={!entry.category_obj_ref.category_id}
                  >
                    <option value="">Select Subcategory</option>
                    {subcategories[entry.category_obj_ref.category_id]?.map((subcat) => (
