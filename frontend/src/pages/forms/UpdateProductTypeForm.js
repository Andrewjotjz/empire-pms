...
const UpdateProductTypeForm = () => {
    ...
    return (
        ...
        <div className="container mx-auto mt-4 sm:mt-10 px-4 sm:px-6 lg:px-8">
          <LoadingOverlay  isLoading={isLoading || isUpdating}/>
            ...
            <form className="p-4 sm:p-6 space-y-2 sm:space-y-6 text-xs sm:text-base" onSubmit={handleSubmit}>
              ...
              <div className='grid grid-cols-2'>
                ...
                <div className='grid grid-cols-3'>
                    ...
                    className="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm font-medium text-white bg-red-600 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition duration-150 ease-in-out col-start-2 text-xs sm:text-sm"
                    >
                    { productTypeState.type_isarchived && (
                    ...
                    <label>{productTypeState && productTypeState.type_isarchived ? `Unarchive` : `Archive`}</label>
                    </button>
                    <button
                    type="submit"
                    className="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm font-medium text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition duration-150 ease-in-out col-start-3 text-xs sm:text-sm ml-2"
                    >
                    UPDATE
                    </button>
                </div>
