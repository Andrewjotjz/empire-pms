...
const PaymentDetails = () => {
  ...
  const getSelectedCompanyNames = () => {
    if (!paymentState.companies || paymentState.companies.length === 0) return "No companies selected"

    const selectedCompanies = companyState.filter((company) => paymentState.companies.includes(company._id))

    if (selectedCompanies.length === 1) {
      return selectedCompanies[0].company_name
    }
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="bg-white rounded-lg shadow-lg p-8 max-w-md w-full mx-4">
          <LoadingSpinner size="large" text="Loading payment details..." />
        </div>
      </div>
    )
  }
          ...
          <div className="p-6 space-y-8">
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div>
                  ...
                  <div className="w-full px-4 py-3 bg-gray-50 border border-gray-300 rounded-lg text-gray-900">
                    {supplierState.find((supplier) => supplier._id === paymentState.supplier)?.supplier_name || "N/A"}
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="w-full px-4 py-3 bg-gray-50 border border-gray-300 rounded-lg text-gray-900">
                    {paymentState.payment_type}
                  </div>
                </div>

                <div>
                  <label className="block text-sm font-semibold text-gray-700 mb-2">Total Amount (incl. GST)</label>
                  <div className="w-full px-4 py-3 bg-gray-50 border border-gray-300 rounded-lg text-gray-900 font-medium">
                    {formatCurrency(paymentState.payment_raw_total_amount_incl_gst)}
                  </div>
                </div>
                  ...
                  <div className="w-full px-4 py-3 bg-gray-50 border border-gray-300 rounded-lg">
                    <span
                      className={`px-2 py-1 rounded-full text-xs font-semibold ${
                        paymentState.payment_status === "Fully Settled"
                          ? "bg-green-100 text-green-800"
                          : paymentState.payment_status === "Partially Settled"
                            ? "bg-yellow-100 text-yellow-800"
                            : paymentState.payment_status === "In Review"
                              ? "bg-blue-100 text-blue-800"
                              : paymentState.payment_status === "Statement Checked"
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {/* <div>
                  <label className="block text-sm font-semibold text-gray-700 mb-2">Selected Companies</label>
                  <div className="w-full px-4 py-3 bg-gray-50 border border-gray-300 rounded-lg text-gray-900">
                ...
                <div>
                    ...
                    <div className="w-full px-4 py-3 bg-gray-50 border border-gray-300 rounded-lg text-gray-900">
                        {paymentState.period_start_date && paymentState.period_end_date ? (
                        <>
                            {formatDate(paymentState.period_start_date)} to {formatDate(paymentState.period_end_date)}
                        </>
                        ) : (
                        "N/A"
                        )}
                  ...
                  <table className="w-full text-sm text-left">
                    ...
                    <tbody>
                      ...
                      <tr className="bg-gray-50">
                        ...
                        <td className="px-6 py-3 font-bold text-green-600">{formatCurrency(totalPaidAmount)}</td>
                      </tr>
                      <tr className="bg-gray-50">
                        <td colSpan={5} className="px-6 py-3 font-bold text-right">
                          Total Due:
                  ...
                  <div key={index} className="flex items-center gap-4 p-4 bg-gray-50 rounded-lg">
                    <div className="flex-1">
                      ...
                      <div className="w-full px-4 py-3 bg-white border border-gray-300 rounded-lg text-gray-900">
                        {formatDate(term.payment_datetime)}
                      </div>
                    </div>
                    <div className="flex-1">
                      ...
                      <div className="w-full px-4 py-3 bg-white border border-gray-300 rounded-lg text-gray-900 font-medium">
                        {formatCurrency(term.payment_amount_paid)}
                      </div>
                    </div>
            ...
            <div>
              ...
              <div className="w-full px-4 py-3 bg-gray-50 border border-gray-300 rounded-lg text-gray-900 min-h-[100px]">
                {paymentState.payment_internal_comments || "No comments provided."}
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-between pt-6 border-t border-gray-200">
              ...
              { localUser.employee_mobile_phone === "0435303047" && <button
                type="button"
