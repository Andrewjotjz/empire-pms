    ...
    <div className="bg-gray-100 min-h-screen">
        <div className="container mx-auto px-4 py-8">
            <div className="bg-white rounded-lg shadow-sm p-6">
                    {localUser.employee_roles === "Admin" && <div className="flex justify-end items-center mb-6">
                        <button
                        onClick={handleEdit}
                        ...
                        <div className="overflow-x-auto rounded-lg shadow overflow-hidden">
                            ...
                            <tbody className="divide-y divide-gray-200">
                                ...
                                <tr key={index} className="hover:bg-gray-50 transition-colors duration-200">
                                    ...
                                    <span className={`px-2 py-1 rounded-full ${product?.delivered_qty_a > 0 ? 'bg-blue-100 text-blue-800' : 'bg-yellow-100 text-yellow-800'}`}>
