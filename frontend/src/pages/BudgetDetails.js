...
export default function BudgetPlanner() {
  ...
  // Calculate 'Total Rate by Product Type based on selected area/level/subarea' for Summary
  ...
  // Calculate 'Total Rate by Product Type + Category based on selected area/level/subarea' for Summary
      ...
      <div className="bg-white shadow-md rounded-lg p-6">
        ...
        <div className="mb-8">
          ...
          <select disabled={true}
            ...
            className="w-full p-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent disabled:bg-gray-50"
          >
          ...
          <div className="space-y-6">
            ...
            <div className="flex justify-end mt-8">
              <button
                ...
                onClick={() => navigate(`/EmpirePMS/budget/${id}/edit`)}
              >
                Edit Budget
              </button>
            </div>
