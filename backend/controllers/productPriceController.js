...
const createNewProductPrice = async (req, res) => {
    ...
    const { product_id, product_unit_a, product_number_a, product_price_unit_a, product_unit_b,
    ...
    try {
        ...
        const ProjectPrice = await productPriceModel.create({ product_id, product_unit_a, product_number_a, product_price_unit_a, product_unit_b,
