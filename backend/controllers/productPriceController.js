...
const createNewProductPrice = async (req, res) => {
    ...
    const { product_obj_ref, product_unit_a, product_number_a, product_price_unit_a, product_unit_b,
        product_number_b, product_price_unit_b, product_price_note, price_fixed, product_actual_rate, product_effective_date, projects } = req.body;
    ...
    try {
        ...
        const ProjectPrice = await productPriceModel.create({ product_obj_ref, product_unit_a, product_number_a, product_price_unit_a, product_unit_b, product_price_note,
            product_number_b, product_price_unit_b, price_fixed, product_actual_rate, product_effective_date, projects })
        //invoke 'res' object method: status() and json(), pass relevant data to them
